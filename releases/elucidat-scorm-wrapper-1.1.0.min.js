/* Elucidat SCORM API wrapper - https://github.com/elucidat/eluciat-scorm-wrapper/ - Version 1.0.4 - Licensed under the MIT license - Copyright (c) 2014 Elucidat Ltd*/
...
var Scorm=function(a){this.options=$.extend({},{debug_mode:"2004"},a);this.mode=this.scorm_interface=null;this.active=!1;this.interactions=this.objectives=0;this.start_time=(new Date).getTime();this.is_debug=this.has_score=!1;this._search_for_api(window);null==this.scorm_interface?(this.mode=this.options.debug_mode,this.is_debug=!0,console.log("LMS not present - Created SCORM "+this.mode+" Debug interface."),this.scorm_interface=new Debug_API):(this.mode="LMSCommit"in this.scorm_interface?"1.2":"2004",
console.log("Found SCORM "+this.mode+" interface."))};Scorm.prototype._format_time=function(a){function b(a,b){var c="0000"+new String(Math.round(a));return c.substr(c.length-b)}a/=1E3;if("2004"==this.mode)return Math.round(a);var c=Math.floor(a/3600);a-=3600*c;var d=Math.floor(a/60);a-=60*d;return b(c,4)+":"+b(d,2)+":"+b(a,2)};
...
Scorm.prototype.SetScoreThreshold=function(a){"2004"==this.mode&&this.SetValue("cmi.scaled_passing_score",a)};Scorm.prototype.SetSessionTime=function(a){a||(a=(new Date).getTime()-this.start_time);if("2004"==this.mode)return this.SetValue("cmi.session_time",this._format_time(a));if("1.2"==this.mode)return this.SetValue("cmi.core.session_time",this._format_time(a))};
...
Scorm.prototype.SetCompletionStatus=function(a){if("2004"==this.mode)return this.SetValue("cmi.completion_status",a);if("1.2"==this.mode)return this.SetValue("cmi.core.lesson_status",a)};Scorm.prototype.GetResult=function(){if("2004"==this.mode)return this.GetValue("cmi.success_status");if("1.2"==this.mode){var a=this.GetValue("cmi.core.lesson_status");return"passed"==a||"failed"==a?a:"unknown"}};
