...
console.log("Found SCORM "+this.mode+" interface."))};Scorm.prototype._format_time=function(a){function b(a,b){var c="0000"+new String(Math.round(a));return c.substr(c.length-b)}a/=1E3;if("2004"==this.mode)return Math.round(a);var c=Math.floor(a/3600);a-=3600*c;var d=Math.floor(a/60);a-=60*d;return b(c,2)+":"+b(d,2)+":"+b(a,2)};
