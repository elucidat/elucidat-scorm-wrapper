/* Elucidat SCORM API wrapper - https://github.com/elucidat/eluciat-scorm-wrapper/ - Version 1.2.6 - Licensed under the MIT license - Copyright (c) 2015 Elucidat Ltd*/
...
"2004",console.log("Found SCORM "+this.mode+" interface."))};Scorm.prototype._format_time=function(a){function b(a,b){var c="0000"+new String(Math.round(a));return c.substr(c.length-b)}a/=1E3;if("2004"==this.mode)return Math.round(a);var d=Math.floor(a/3600);a-=3600*d;var e=Math.floor(a/60);a-=60*e;return"2004"==this.mode?"PT"+(d?d+"H":"")+(e?e+"M":"")+a+"S":b(d,2)+":"+b(e,2)+":"+b(a,2)};
