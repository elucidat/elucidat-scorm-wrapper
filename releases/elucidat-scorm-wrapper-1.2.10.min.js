/* Elucidat SCORM API wrapper - https://github.com/elucidat/eluciat-scorm-wrapper/ - Version 1.2.10 - Licensed under the MIT license - Copyright (c) 2016 Elucidat Ltd*/
...
Scorm.prototype.SetObjective=function(a,b,c,d,g,k){var e=this.objectives.indexOf(a);-1==e&&(e=this.objectives.length,this.SetValue("cmi.objectives."+e+".id",a),"2004"==this.mode&&this.SetValue("cmi.objectives."+e+".description",k),this.objectives.push(a),this.SetValue("cmi.objectives."+e+".score.min",d?d:0),this.SetValue("cmi.objectives."+e+".score.max",g?g:100));this.SetValue("cmi.objectives."+e+".score.raw",c?c:0);"2004"==this.mode?(this.SetValue("cmi.objectives."+e+".completion_status","completed"),
...
Scorm.prototype.SetInteraction=function(a,b,c,d,g,k,e){var f=this.interactions.indexOf(a),h="1.2"==this.mode?!0:!1;-1==f&&(f=this.interactions.length,this.SetValue("cmi.interactions."+f+".id",a,h),this.SetValue("cmi.interactions."+f+".objectives.0.id",b,h),"2004"==this.mode&&(this.SetValue("cmi.interactions."+f+".description",g),this.SetValue("cmi.interactions."+f+".type",k)),this.interactions.push(a));d&&("2004"==this.mode&&k&&e?(a=d.split("[:]"),a[0]&&(d=a[0]),this.SetValue("cmi.interactions."+
f+".learner_response",d),this.SetValue("cmi.interactions."+f+".correct_responses.0.pattern",e)):this.SetValue("cmi.interactions."+f+".student_response",d,h));"passed"==c||"completed"==c?this.SetValue("cmi.interactions."+f+".result","correct",h):"failed"==c&&("2004"==this.mode?this.SetValue("cmi.interactions."+f+".result","incorrect"):this.SetValue("cmi.interactions."+f+".result","wrong",h))};
