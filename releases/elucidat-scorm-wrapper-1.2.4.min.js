/* Elucidat SCORM API wrapper - https://github.com/elucidat/eluciat-scorm-wrapper/ - Version 1.2.4 - Licensed under the MIT license - Copyright (c) 2015 Elucidat Ltd*/
...
Scorm.prototype.SetInteraction=function(a,b,c,d,g){var e=this.interactions.indexOf(a);-1==e&&(e=this.interactions.length,this.SetValue("cmi.interactions."+e+".id",a),this.SetValue("cmi.interactions."+e+".objectives.0.id",b),"2004"==this.mode&&this.SetValue("cmi.interactions."+e+".description",g),this.interactions.push(a));d&&("2004"==this.mode?this.SetValue("cmi.interactions."+e+".learner_response",d):this.SetValue("cmi.interactions."+e+".student_response",d));"passed"==c||"completed"==c?this.SetValue("cmi.interactions."+
