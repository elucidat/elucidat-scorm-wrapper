/* Elucidat SCORM API wrapper - https://github.com/elucidat/eluciat-scorm-wrapper/ - Version 1.2.5 - Licensed under the MIT license - Copyright (c) 2015 Elucidat Ltd*/
...
var Scorm=function(a){this.options=$.extend({},{debug_mode:"1.2"},a);this.mode=this.scorm_interface=null;this.active=!1;this.objectives=[];this.interactions=[];this.start_time=(new Date).getTime();this.is_debug=this.has_score=!1;this._search_for_api(window);null==this.scorm_interface?(this.mode=this.options.debug_mode,this.is_debug=!0,console.log("LMS not present - Created SCORM "+this.mode+" Debug interface."),this.scorm_interface=new Debug_API):(this.mode="LMSCommit"in this.scorm_interface?"1.2":
"2004",console.log("Found SCORM "+this.mode+" interface."))};Scorm.prototype._format_time=function(a){function b(a,b){var c="0000"+new String(Math.round(a));return c.substr(c.length-b)}a/=1E3;if("2004"==this.mode)return Math.round(a);var d=Math.floor(a/3600);a-=3600*d;var e=Math.floor(a/60);a-=60*e;return b(d,2)+":"+b(e,2)+":"+b(a,2)};
...
Scorm.prototype.SetIncomplete=function(){this.SetCompletionStatus("incomplete")};Scorm.prototype.SetScore=function(a,b,d){this.has_score=!0;"2004"==this.mode?(this.SetValue("cmi.score.raw",a),this.SetValue("cmi.score.scaled",1/d*a),this.SetValue("cmi.score.min",b),this.SetValue("cmi.score.max",d)):"1.2"==this.mode&&(this.SetValue("cmi.core.score.raw",a),this.SetValue("cmi.core.score.min",b),this.SetValue("cmi.core.score.max",d));this.Commit()};
...
c):"failed"==d&&("2004"==this.mode?this.SetValue("cmi.interactions."+f+".result","incorrect"):this.SetValue("cmi.interactions."+f+".result","wrong",c))};
