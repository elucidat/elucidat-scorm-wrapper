...
"2004",console.log("Found SCORM "+this.mode+" interface."))};Scorm.prototype._format_time=function(a){function b(a,b){var c="0000"+new String(Math.round(a));return c.substr(c.length-b)}a/=1E3;if("2004"==this.mode)return Math.round(a);var c=Math.floor(a/3600);a-=3600*c;var e=Math.floor(a/60);a-=60*e;return b(c,2)+":"+b(e,2)+":"+b(a,2)};
...
Scorm.prototype.SetValue=function(a,b,c){if(this.active){var e;"2004"==this.mode?(this.scorm_interface.SetValue(a,b),c||(e=this.scorm_interface.GetValue(a))):"1.2"==this.mode&&(this.scorm_interface.LMSSetValue(a,b),c||(e=this.scorm_interface.LMSGetValue(a)));top.postMessage&&top.postMessage(a+"="+b,"*");var g=this.Check();a="Scorm:SetValue: "+a+"="+b;c||(a+="? "+(g.code?g.description:"Echo:"+e));console.log(a);console.log(c?"SKIP skip_checking":"");return g.code}};
...
Scorm.prototype.SetObjective=function(a,b,c,e,g,d){var f=this.objectives.indexOf(a);-1==f&&(f=this.objectives.length,this.SetValue("cmi.objectives."+f+".id",a),"2004"==this.mode&&this.SetValue("cmi.objectives."+f+".description",d),this.objectives.push(a),this.SetValue("cmi.objectives."+f+".score.min",e?e:0),this.SetValue("cmi.objectives."+f+".score.max",g?g:100));this.SetValue("cmi.objectives."+f+".score.raw",c?c:0);"2004"==this.mode?(this.SetValue("cmi.objectives."+f+".completion_status","completed"),
...
Scorm.prototype.SetInteraction=function(a,b,c,e,g){var d=this.interactions.indexOf(a);-1==d&&(d=this.interactions.length,this.SetValue("cmi.interactions."+d+".id",a),this.SetValue("cmi.interactions."+d+".objectives.0.id",b),"2004"==this.mode&&this.SetValue("cmi.interactions."+d+".description",g),this.interactions.push(a));e&&("2004"==this.mode?this.SetValue("cmi.interactions."+d+".learner_response",e):this.SetValue("cmi.interactions."+d+".student_response",e,!0));"passed"==c||"completed"==c?"2004"==
this.mode?this.SetValue("cmi.interactions."+d+".result","correct"):this.SetValue("cmi.interactions."+d+".result","correct",!0):"failed"==c&&("2004"==this.mode?this.SetValue("cmi.interactions."+d+".result","incorrect"):this.SetValue("cmi.interactions."+d+".result","wrong",!0))};
