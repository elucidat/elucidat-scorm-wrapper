/* Elucidat SCORM API wrapper - https://github.com/elucidat/eluciat-scorm-wrapper/ - Version 1.0.3 - Licensed under the MIT license - Copyright (c) 2014 Elucidat Ltd*/
...
Scorm.prototype.Initialize=function(){console.log("Scorm:Initialize");"2004"==this.mode?this.scorm_interface.Initialize(""):"1.2"==this.mode&&this.scorm_interface.LMSInitialize("");0==this.Check().code&&(this.active=!0);"not attempted"==this.GetCompletionStatus()&&this.SetCompletionStatus("incomplete");return this.active};
