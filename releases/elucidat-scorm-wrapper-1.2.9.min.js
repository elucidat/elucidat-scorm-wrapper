...
Scorm.prototype.SetInteraction=function(a,b,d,e,g){var f=this.interactions.indexOf(a),c="1.2"==this.mode?!0:!1;-1==f&&(f=this.interactions.length,this.SetValue("cmi.interactions."+f+".id",a,c),this.SetValue("cmi.interactions."+f+".objectives.0.id",b,c),"2004"==this.mode&&this.SetValue("cmi.interactions."+f+".description",g),this.interactions.push(a));e&&("2004"==this.mode?this.SetValue("cmi.interactions."+f+".learner_response",e):this.SetValue("cmi.interactions."+f+".student_response",e,c));"passed"==
d||"completed"==d?this.SetValue("cmi.interactions."+f+".result","correct",c):"failed"==d&&("2004"==this.mode?this.SetValue("cmi.interactions."+f+".result","incorrect"):this.SetValue("cmi.interactions."+f+".result","wrong",c))};
