...
"2004",console.log("Found SCORM "+this.mode+" interface."))};Scorm.prototype._format_time=function(a){function b(a,b){var c="0000"+new String(Math.round(a));return c.substr(c.length-b)}a/=1E3;var c=Math.floor(a/3600);a-=3600*c;var e=Math.floor(a/60);a-=60*e;return"2004"==this.mode?"PT"+(c?c+"H":"")+(e?e+"M":"")+Math.round(a)+"S":b(c,2)+":"+b(e,2)+":"+b(a,2)};
...
Scorm.prototype.SetObjective=function(a,b,c,e,g,k){var f=this.objectives.indexOf(a);-1==f&&(f=this.objectives.length,this.SetValue("cmi.objectives."+f+".id",a),"2004"==this.mode&&this.SetValue("cmi.objectives."+f+".description",k),this.objectives.push(a),this.SetValue("cmi.objectives."+f+".score.min",e?e:0),this.SetValue("cmi.objectives."+f+".score.max",g?g:100));this.SetValue("cmi.objectives."+f+".score.raw",c?c:0);"2004"==this.mode?(this.SetValue("cmi.objectives."+f+".completion_status","completed"),
...
Scorm.prototype.SetInteraction=function(a,b,c,e,g,k,f,l){var d=this.interactions.indexOf(a),h="1.2"==this.mode?!0:!1;-1==d&&(d=this.interactions.length,this.SetValue("cmi.interactions."+d+".id",a,h),this.SetValue("cmi.interactions."+d+".objectives.0.id",b,h),"2004"==this.mode&&(this.SetValue("cmi.interactions."+d+".description",g),this.SetValue("cmi.interactions."+d+".type",k)),this.interactions.push(a));e&&("2004"==this.mode?k&&f&&(a=e.split("[:]").join("__").replace(/ /g,"_"),this.SetValue("cmi.interactions."+
d+".learner_response",a),this.GetValue("cmi.interactions."+d+".learner_response")!=a&&(this.SetValue("cmi.interactions."+d+".learner_response","elucidaterror"),this.SetValue("cmi.interactions."+d+".learner_response",a),this.GetValue("cmi.interactions."+d+".learner_response")!=a&&(a=a.split("[,]").join("__"),this.SetValue("cmi.interactions."+d+".learner_response",a))),this.SetValue("cmi.interactions."+d+".correct_responses.0.pattern",f),this.SetValue("cmi.interactions."+d+".weighting",l)):this.SetValue("cmi.interactions."+
d+".student_response",e,h));"neutral"==c?this.SetValue("cmi.interactions."+d+".result","neutral",h):"passed"==c||"completed"==c?this.SetValue("cmi.interactions."+d+".result","correct",h):"failed"==c&&("2004"==this.mode?this.SetValue("cmi.interactions."+d+".result","incorrect"):this.SetValue("cmi.interactions."+d+".result","wrong",h))};
