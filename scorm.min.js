...
"2004",console.log("Found SCORM "+this.mode+" interface."))};Scorm.prototype._format_time=function(a){function b(a,b){var c="0000"+new String(Math.round(a));return c.substr(c.length-b)}a/=1E3;var c=Math.floor(a/3600);a-=3600*c;var f=Math.floor(a/60);a-=60*f;return"2004"==this.mode?"PT"+(c?c+"H":"")+(f?f+"M":"")+Math.round(a)+"S":b(c,2)+":"+b(f,2)+":"+b(a,2)};
...
Scorm.prototype.SetValue=function(a,b,c){if(this.active){var f;"2004"==this.mode?(this.scorm_interface.SetValue(a,b),c||(f=this.scorm_interface.GetValue(a))):"1.2"==this.mode&&(this.scorm_interface.LMSSetValue(a,b),c||(f=this.scorm_interface.LMSGetValue(a)));top.postMessage&&top.postMessage(a+"="+b,"*");var g=this.Check();a="Scorm:SetValue: "+a+"="+b;c||(a+="? "+(g.code?g.description:"Echo:"+f));console.log(a);return g.code}};
...
Scorm.prototype.SetObjective=function(a,b,c,f,g,k){var e=this.objectives.indexOf(a);-1==e&&(e=this.objectives.length,this.SetValue("cmi.objectives."+e+".id",a),"2004"==this.mode&&this.SetValue("cmi.objectives."+e+".description",k),this.objectives.push(a),this.SetValue("cmi.objectives."+e+".score.min",f?f:0),this.SetValue("cmi.objectives."+e+".score.max",g?g:100));this.SetValue("cmi.objectives."+e+".score.raw",c?c:0);"2004"==this.mode?(this.SetValue("cmi.objectives."+e+".completion_status","completed"),
("passed"==b||"failed"==b)&&this.SetValue("cmi.objectives."+e+".success_status",b)):"passed"==b||"failed"==b?this.SetValue("cmi.objectives."+e+".status",b):this.SetValue("cmi.objectives."+e+".status","completed")};
Scorm.prototype.SetInteraction=function(a,b,c,f,g,k,e,l){var d=this.interactions.indexOf(a),h="1.2"==this.mode?!0:!1;-1==d&&(d=this.interactions.length,this.SetValue("cmi.interactions."+d+".id",a,h),this.SetValue("cmi.interactions."+d+".objectives.0.id",b,h),"2004"==this.mode&&(this.SetValue("cmi.interactions."+d+".description",g),this.SetValue("cmi.interactions."+d+".type",k)),this.interactions.push(a));f&&("2004"==this.mode?k&&e&&(this.SetValue("cmi.interactions."+d+".learner_response",response),
this.GetValue("cmi.interactions."+d+".learner_response")!=response&&(this.SetValue("cmi.interactions."+d+".learner_response","elucidaterror"),this.SetValue("cmi.interactions."+d+".learner_response",response),this.GetValue("cmi.interactions."+d+".learner_response")!=response&&(a=response.split("[,]").join("__"),this.SetValue("cmi.interactions."+d+".learner_response",a))),this.SetValue("cmi.interactions."+d+".correct_responses.0.pattern",e),this.SetValue("cmi.interactions."+d+".weighting",l)):this.SetValue("cmi.interactions."+
d+".student_response",f,h));"neutral"==c?this.SetValue("cmi.interactions."+d+".result","neutral",h):"passed"==c||"completed"==c?this.SetValue("cmi.interactions."+d+".result","correct",h):"failed"==c&&("2004"==this.mode?this.SetValue("cmi.interactions."+d+".result","incorrect"):this.SetValue("cmi.interactions."+d+".result","wrong",h))};
