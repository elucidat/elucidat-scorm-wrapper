...
var Scorm=function(){this.scorm_interface=null;this.mode="2004";this.active=!1;this.objectives=0;this.start_time=(new Date).getTime()/1E3;this.has_score=!1;this.pass_action="completed";this._search_for_api(window);null==this.scorm_interface?(console.log("LMS not present - Created SCORM "+this.mode+" Debug interface."),this.scorm_interface=new Debug_API):console.log("Found SCORM "+this.mode+" interface.")};
...
Scorm.prototype._search_for_api=function(a){try{for(;null!=a&&null==this.scorm_interface;)a.API_1484_11?(this.scorm_interface=a.API_1484_11,this.mode="2004"):a.API&&(this.scorm_interface=a.API,this.mode="1.2"),null==a.opener||a.opener.closed||this._search_for_api(a.opener),a=a==a.parent?null:a.parent}catch(b){return null}};
