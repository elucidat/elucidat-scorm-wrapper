...
Scorm.prototype.SetObjective=function(a,b,c,d,g,h){var e=this.objectives.indexOf(a);-1==e&&(e=this.objectives.length,this.SetValue("cmi.objectives."+e+".id",a),"2004"==this.mode&&this.SetValue("cmi.objectives."+e+".description",h),this.objectives.push(a),this.SetValue("cmi.objectives."+e+".score.min",d?d:0),this.SetValue("cmi.objectives."+e+".score.max",g?g:100));this.SetValue("cmi.objectives."+e+".score.raw",c?c:0);"2004"==this.mode?(this.SetValue("cmi.objectives."+e+".completion_status","completed"),
...
Scorm.prototype.SetInteraction=function(a,b,c,d,g,h,e){var f=this.interactions.indexOf(a),k="1.2"==this.mode?!0:!1;-1==f&&(f=this.interactions.length,this.SetValue("cmi.interactions."+f+".id",a,k),this.SetValue("cmi.interactions."+f+".objectives.0.id",b,k),"2004"==this.mode&&(this.SetValue("cmi.interactions."+f+".description",g),this.SetValue("cmi.interactions."+f+".type",h)),this.interactions.push(a));d&&("2004"==this.mode?(console.log("interaction_type: "+h),console.log("correct_response: "+e),
h&&e&&(a=d[i].split("[:]"),d=d[i],a[0]&&(d=a[0]),this.SetValue("cmi.interactions."+f+".learner_response",d),this.SetValue("cmi.interactions."+f+".correct_responses.0.pattern",e))):this.SetValue("cmi.interactions."+f+".student_response",d[i],k));"passed"==c||"completed"==c?this.SetValue("cmi.interactions."+f+".result","correct",k):"failed"==c&&("2004"==this.mode?this.SetValue("cmi.interactions."+f+".result","incorrect"):this.SetValue("cmi.interactions."+f+".result","wrong",k))};
