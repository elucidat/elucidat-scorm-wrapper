...
Scorm.prototype.SetValue=function(a,b,d){if(this.active){var e;"2004"==this.mode?(this.scorm_interface.SetValue(a,b),d||(e=this.scorm_interface.GetValue(a))):"1.2"==this.mode&&(this.scorm_interface.LMSSetValue(a,b),d||(e=this.scorm_interface.LMSGetValue(a)));top.postMessage&&top.postMessage(a+"="+b,"*");var f=this.Check();a="Scorm:SetValue: "+a+"="+b;d||(a+="? "+(f.code?f.description:"Echo:"+e));console.log(a);return f.code}};
...
Scorm.prototype.SetObjective=function(a,b,d,e,f,h){var c=this.objectives.indexOf(a);-1==c&&(c=this.objectives.length,this.SetValue("cmi.objectives."+c+".id",a),"2004"==this.mode&&this.SetValue("cmi.objectives."+c+".description",h),this.objectives.push(a),this.SetValue("cmi.objectives."+c+".score.min",e?e:0),this.SetValue("cmi.objectives."+c+".score.max",f?f:100));this.SetValue("cmi.objectives."+c+".score.raw",d?d:0);"2004"==this.mode?(this.SetValue("cmi.objectives."+c+".completion_status","completed"),
...
Scorm.prototype.SetInteraction=function(a,b,d,e,f,h){var c=this.interactions.indexOf(a),g="1.2"==this.mode?!0:!1;-1==c&&(c=this.interactions.length,this.SetValue("cmi.interactions."+c+".id",a,g),this.SetValue("cmi.interactions."+c+".objectives.0.id",b,g),"2004"==this.mode&&(this.SetValue("cmi.interactions."+c+".description",f),this.SetValue("cmi.interactions."+c+".type",h)),this.interactions.push(a));e&&("2004"==this.mode&&h?this.SetValue("cmi.interactions."+c+".learner_response",e):this.SetValue("cmi.interactions."+
c+".student_response",e,g));"passed"==d||"completed"==d?this.SetValue("cmi.interactions."+c+".result","correct",g):"failed"==d&&("2004"==this.mode?this.SetValue("cmi.interactions."+c+".result","incorrect"):this.SetValue("cmi.interactions."+c+".result","wrong",g))};
