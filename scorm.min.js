...
Scorm.prototype.SetInteraction=function(a,b,c,d,g,k,e){var f=this.interactions.indexOf(a),h="1.2"==this.mode?!0:!1;-1==f&&(f=this.interactions.length,this.SetValue("cmi.interactions."+f+".id",a,h),this.SetValue("cmi.interactions."+f+".objectives.0.id",b,h),"2004"==this.mode&&(this.SetValue("cmi.interactions."+f+".description",g),this.SetValue("cmi.interactions."+f+".type",k)),this.interactions.push(a));d&&("2004"==this.mode?k&&e&&(a=d.split("[:]").join("__").replace(/ /g,"_"),this.SetValue("cmi.interactions."+
f+".learner_response",a),this.SetValue("cmi.interactions."+f+".correct_responses.0.pattern",e)):this.SetValue("cmi.interactions."+f+".student_response",d,h));"neutral"==c?this.SetValue("cmi.interactions."+f+".result","neutral",h):"passed"==c||"completed"==c?this.SetValue("cmi.interactions."+f+".result","correct",h):"failed"==c&&("2004"==this.mode?this.SetValue("cmi.interactions."+f+".result","incorrect"):this.SetValue("cmi.interactions."+f+".result","wrong",h))};
