...
var Scorm=function(a){this.options=$.extend({},{debug_mode:"2004"},a);this.mode=this.scorm_interface=null;this.active=!1;this.objectives=0;this.start_time=(new Date).getTime()/1E3;this.is_debug=this.has_score=!1;this._search_for_api(window);null==this.scorm_interface?(this.mode=this.options.debug_mode,this.is_debug=!0,console.log("LMS not present - Created SCORM "+this.mode+" Debug interface."),this.scorm_interface=new Debug_API):(this.mode="LMSCommit"in this.scorm_interface?"1.2":"2004",console.log("Found SCORM "+
this.mode+" interface."))};Scorm.prototype._get_session_time=function(a){function b(a,b){var c="0000"+new String(Math.round(a));return c.substr(c.length-b)}var c=(new Date).getTime()/1E3-this.start_time;if("2004"==a)return Math.round(c);a=Math.floor(c/3600);var c=c-3600*a,d=Math.floor(c/60),c=c-60*d;return b(a,4)+":"+b(d,2)+":"+b(c,2)};
