...
Scorm.prototype.SetInteraction=function(a,b,c,e,g,k,f){var d=this.interactions.indexOf(a),h="1.2"==this.mode?!0:!1;-1==d&&(d=this.interactions.length,this.SetValue("cmi.interactions."+d+".id",a,h),this.SetValue("cmi.interactions."+d+".objectives.0.id",b,h),"2004"==this.mode&&(this.SetValue("cmi.interactions."+d+".description",g),this.SetValue("cmi.interactions."+d+".type",k)),this.interactions.push(a));e&&("2004"==this.mode?k&&f&&(a=e.split("[:]").join("__").replace(/ /g,"_"),this.SetValue("cmi.interactions."+
d+".learner_response",a),this.GetValue("cmi.interactions."+d+".learner_response")!=a&&(this.SetValue("cmi.interactions."+d+".learner_response","elucidaterror"),this.SetValue("cmi.interactions."+d+".learner_response",a),this.GetValue("cmi.interactions."+d+".learner_response")!=a&&(a=a.split("[,]").join("__"),this.SetValue("cmi.interactions."+d+".learner_response",a))),this.SetValue("cmi.interactions."+d+".correct_responses.0.pattern",f)):this.SetValue("cmi.interactions."+d+".student_response",e,h));
"neutral"==c?this.SetValue("cmi.interactions."+d+".result","neutral",h):"passed"==c||"completed"==c?this.SetValue("cmi.interactions."+d+".result","correct",h):"failed"==c&&("2004"==this.mode?this.SetValue("cmi.interactions."+d+".result","incorrect"):this.SetValue("cmi.interactions."+d+".result","wrong",h))};
